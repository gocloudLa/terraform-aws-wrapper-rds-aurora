...
module "db_management" {
  ...
  create      = try(each.value.enable_db_management, var.rds_aurora_defaults.enable_db_management, false)
  ...
  timeout     = try(each.value.db_management_timeout, var.rds_aurora_defaults.db_management_timeout, 300)
  memory_size = try(each.value.db_management_memory_size, var.rds_aurora_defaults.db_management_memory_size, 256)
