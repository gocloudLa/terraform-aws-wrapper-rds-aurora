module "rds_aurora" {
  ...
  db_cluster_parameter_group_use_name_prefix = try(each.value.db_cluster_parameter_group_use_use_name_prefix , var.rds_aurora_defaults.db_cluster_parameter_group_use_use_name_prefix , false)
