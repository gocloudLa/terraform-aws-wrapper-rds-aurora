...
| Name | Version |
|------|------:|
| <a href="https://github.com/terraform-aws-modules/terraform-aws-eventbridge" target="_blank">terraform-aws-modules/eventbridge/aws</a> | 4.3.1 |
...
| <a href="https://github.com/terraform-aws-modules/terraform-aws-s3-bucket" target="_blank">terraform-aws-modules/s3-bucket/aws</a> | 5.15.3 |
...
| <a href="https://github.com/terraform-aws-modules/terraform-aws-ssm-parameter" target="_blank">terraform-aws-modules/ssm-parameter/aws</a> | 2.1.1 |
...
<details><summary>PostgreSQL Cluster</summary>
...
| cluster_instance_class                            | Cluster instance class                                                                                                                                                                                         | `string` | `null`                                                       | no       |
...
| vpc_security_group_ids                            | Identifiers of the VPC security groups                                                                                                                                                                         | `list`   | `local.rds_vpc_security_group_ids[each.key]`                 | no       |
...
| cluster_parameter_group_parameters                | Cluster parameter group parameters                                                                                                                                                                             | `list`   | `[]`                                                         | no       |
| cluster_parameter_group_name                      | Cluster parameter group name                                                                                                                                                                                   | `string` | `"${local.common_name}-${key}-cpg"`                          | no       |
| cluster_parameter_group_use_name_prefix           | Cluster parameter group for use name prefix                                                                                                                                                                    | `bool`   | `true`                                                       | no       |
| cluster_parameter_group_description               | Cluster parameter group description                                                                                                                                                                            | `string` | `"Cluster parameter group for ${local.common_name}-${key}"`  | no       |
| cluster_parameter_group_family                    | Cluster parameter group family (e.g. aurora-mysql8.0)                                                                                                                                                          | `string` | Derived from engine + engine_version                         | no       |
| db_parameter_group_name                           | Database parameter group name                                                                                                                                                                                  | `string` | `"${local.common_name}-${key}-cpg"`                          | no       |
| db_parameter_group_use_name_prefix                | Database parameter group for use name prefix                                                                                                                                                                   | `bool`   | `true`                                                       | no       |
| db_parameter_group_description                    | Database parameter group description                                                                                                                                                                           | `string` | `"Database parameter group for ${local.common_name}-${key}"` | no       |
| db_parameter_group_family                         | Database parameter group family (e.g. aurora-mysql8.0)                                                                                                                                                         | `string` | Derived from engine + engine_version                         | no       |
| db_parameter_group_parameters                     | Database parameter group parameters                                                                                                                                                                            | `list`   | `[]`                                                         | no       |
| security_group_create                             | Create the Security Group (wrapper; RDS module never creates its own)                                                                                                                                          | `bool`   | `true`                                                       | no       |
| security_group_name                               | Security Group name                                                                                                                                                                                            | `string` | `"${local.common_name}-rds-${each.key}"`                     | no       |
| security_group_description                        | Security Group description                                                                                                                                                                                     | `string` | `"Security Group managed by Terraform"`                      | no       |
| ingress_with_cidr_blocks                          | Ingress rules with CIDR blocks                                                                                                                                                                                 | `list`   | MySQL + PostgreSQL from VPC CIDR                             | no       |
| egress_with_cidr_blocks                           | Egress rules with CIDR blocks                                                                                                                                                                                  | `list`   | `[]`                                                         | no       |
| egress_with_ipv6_cidr_blocks                      | Egress rules with IPv6 CIDR blocks                                                                                                                                                                             | `list`   | `[]`                                                         | no       |
| vpc_security_group_ids                            | Additional existing Security Group IDs to attach to the cluster                                                                                                                                                | `list`   | `[]`                                                         | no       |
| parameter_group_family                            | Parameter group family (e.g. aurora-mysql8.0)                                                                                                                                                                  | `string` | Derived from engine + engine_version                         | no       |
| dns_records                                       | DNS records (Route53) for the cluster endpoint                                                                                                                                                                 | `map`    | `null`                                                       | no       |
| enable_db_management                              | Enable DB user/database management Lambda                                                                                                                                                                      | `bool`   | `false`                                                      | no       |
| enable_db_management_logs_notifications           | Enable notifications for DB management logs                                                                                                                                                                    | `bool`   | `false`                                                      | no       |
| db_management_parameters                          | Databases, users and grants for DB management                                                                                                                                                                  | `map`    | `{}`                                                         | no       |
...
| db_dump_create_s3_arn_permission_accounts         | IAM ARNs allowed to read from dump S3                                                                                                                                                                          | `list`   | `[]`                                                         | no       |
| db_dump_create_retention_in_days                  | S3 object retention in days                                                                                                                                                                                    | `number` | `2`                                                          | no       |
| db_dump_create_local_path_custom_scripts          | Local path for custom SQL scripts                                                                                                                                                                              | `string` | `""`                                                         | no       |
| db_dump_create_timeout                            | Lambda timeout for dump create (seconds)                                                                                                                                                                       | `number` | `300`                                                        | no       |
| db_dump_create_memory_size                        | Lambda memory size for dump create                                                                                                                                                                             | `number` | `256`                                                        | no       |
| enable_db_dump_restore                            | Enable restore from S3 dump (MySQL/MariaDB)                                                                                                                                                                    | `bool`   | `false`                                                      | no       |
| db_dump_restore_s3_bucket_name                    | S3 bucket name for restore                                                                                                                                                                                     | `string` | `""`                                                         | no       |
| db_dump_restore_db_name                           | Database name for restore                                                                                                                                                                                      | `string` | `""`                                                         | no       |
| db_dump_restore_timeout                           | Lambda timeout for restore (seconds)                                                                                                                                                                           | `number` | `300`                                                        | no       |
| db_dump_restore_memory_size                       | Lambda memory size for restore                                                                                                                                                                                 | `number` | `256`                                                        | no       |
...
## ⚠️ Important Notes
- **🔒 Security Group:** The wrapper always manages the Security Group (see `security.tf`). The RDS module never creates one; we pass the wrapper's SG ID (and any extra `vpc_security_group_ids`) to the cluster.
